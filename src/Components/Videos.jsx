  ...
  return (
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack w={'100%'}>
        ...
        <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
          ...
          <Text>
            ...
            ab cupiditate quod velit doloremque, consequatur sapiente recusandae
            quis veritatis.
          </Text>
        </VStack>
      </VStack>
      ...
      >
        ...
        <Button alignItems={'stretch'} variant={'ghost'} colorScheme="purple" onClick={()=>{setVideosrc(item)}}>
          Lecture {index +1}
        </Button>
       ) )}
      </VStack>
